...
export class IntentTypeHandler {
   ...
   * create/edit and state-change operations. This function may do enhanced
  ...
  /**
   * Returns the list of managed devices (neId) for suggesting on WebUI
  ...
  suggestTargetDevices(valueProviderContext) {
    ...
    try  {
      ...
      var mediators = [];
      mds.getAllManagersOfType("REST").forEach(function(mediator) {
      ...
      var devices = mds.getAllManagedDevicesFrom(Arrays.asList(mediators));
